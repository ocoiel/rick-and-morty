...
export function CharacterCard({ character, priority, onSelect, onPrefetch }: CharacterCardProps) {
  return (
    <button
      ...
      className="group relative flex h-full w-full flex-col overflow-hidden rounded-card border border-border bg-surface text-left transition-[translate,border-color,box-shadow,scale] duration-150 ease-[cubic-bezier(0.2,0,0,1)] hover:-translate-y-1 hover:border-portal-dim hover:shadow-[0_8px_30px_-12px_rgba(127,209,74,0.35)] active:scale-[0.96]"
    >
